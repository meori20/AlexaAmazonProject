...
public class UserType implements java.io.Serializable {
    ...
    public static final java.lang.String _SUB_ACCOUNT = "SUB_ACCOUNT";
    public static final UserType MAIN = new UserType(_MAIN);
    public static final UserType SUB_ACCOUNT = new UserType(_SUB_ACCOUNT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://mobile.api.ch.amdocs.com/", "userType"));
    }
    /**
