...
public class ProductStatus implements java.io.Serializable {
    ...
    public static final ProductStatus NEW = new ProductStatus(_NEW);
    public static final ProductStatus ACTIVE = new ProductStatus(_ACTIVE);
    public static final ProductStatus EXPIRED = new ProductStatus(_EXPIRED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://mobile.api.ch.amdocs.com/", "productStatus"));
    }
    /**
