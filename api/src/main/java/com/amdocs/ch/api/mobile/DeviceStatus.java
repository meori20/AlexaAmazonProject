...
public class DeviceStatus implements java.io.Serializable {
    ...
    public static final java.lang.String _UNLOCK = "UNLOCK";
    public static final DeviceStatus ON = new DeviceStatus(_ON);
    public static final DeviceStatus OFF = new DeviceStatus(_OFF);
    public static final DeviceStatus LOCK = new DeviceStatus(_LOCK);
    public static final DeviceStatus UNLOCK = new DeviceStatus(_UNLOCK);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://mobile.api.ch.amdocs.com/", "deviceStatus"));
    }
    /**
