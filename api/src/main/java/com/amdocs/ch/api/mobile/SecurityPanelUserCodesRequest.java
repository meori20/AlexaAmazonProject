/**
 * SecurityPanelUserCodesRequest.java
 *
...
public class SecurityPanelUserCodesRequest  implements java.io.Serializable {
    private com.amdocs.ch.api.mobile.SecurityPanelUserCode[] securityPanelUserCodesList;

    public SecurityPanelUserCodesRequest() {
    }
    ...
    /**
     * Gets the securityPanelUserCodesList value for this SecurityPanelUserCodesRequest.
     * 
    ...
    /**
     * Sets the securityPanelUserCodesList value for this SecurityPanelUserCodesRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SecurityPanelUserCodesRequest)) return false;
        SecurityPanelUserCodesRequest other = (SecurityPanelUserCodesRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SecurityPanelUserCodesRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://mobile.api.ch.amdocs.com/", "securityPanelUserCodesRequest"));
